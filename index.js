...
console.log(createMenuItem('Fries', 8, 'Side'));
console.log(createMenuItem('Chicken SandWhich', 12, 'Lunch'));
console.log(createMenuItem('Soda', 3, 'Drinks'));
...
function addreviews(array, name, rating, feedback){
  ...
  addreviews(reviews, "Kyle", 4.2, "Service was Good.");
  console.log(reviews);
